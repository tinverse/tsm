...
///
template<typename Context,
         template<class> class Policy = detail::SingleThreadedExecutionPolicy>
...
///
template<typename Context,
         template<class> class Policy = detail::ThreadedExecutionPolicy>
...
///
template<typename Context,
         template<class> class Policy = detail::PeriodicExecutionPolicy>
...
///
template<typename Context,
         template<class> class Policy = detail::RealtimePeriodicExecutionPolicy>
using RealtimePeriodicHsm = Policy<Context>;

// Real-time state machine. This state machine is driven by a periodic timer.
template<typename Context,
         template<class> class Policy = detail::RealtimeExecutionPolicy>
using RealtimeHsm = Policy<Context>;

// Concurrent Hsm
template<template<typename> class Policy = detail::ThreadedExecutionPolicy,
         typename... Contexts>
