if (BUILD_COVERAGE)
  ...
  add_custom_target(coverage
    ...
    COMMAND ${LCOV_PATH} --remove ${TEST_PROJECT}_total.info '${PROJECT_BINARY_DIR}/*' -o ${TEST_PROJECT}_total.info.cleaned
    COMMAND ${GENHTML_PATH} -o ${TEST_PROJECT}_test_coverage ${TEST_PROJECT}_total.info.cleaned
